...
export const DatabaseConfig = registerAs(DatabaseConfigName, (): DatabaseConfigModel => {
...
export const getDatabaseConfig = (configService: ConfigService): DatabaseConfigModel =>
